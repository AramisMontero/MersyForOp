namespace Domain.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            ...
            //    new Status() { StatusId = 12, Name = "Pendiente de Autorizacion", Table = "Admision" },
            //    new Status() { StatusId = 13, Name = "Autorizado", Table = "Admision" },
            //    new Status() { StatusId = 14, Name = "Ingresado", Table = "Admision" },
            //    new Status() { StatusId = 15, Name = "Pendiente de Alta", Table = "Admision" },
            //    new Status() { StatusId = 16, Name = "Dado de Alta", Table = "Admision" }
            ...
            //        ParentOptionId = 3,
            //        Name = "Admisions",
            //        Description = "Adminisiones",
            //        Link = "~/Medicals/Patients/Admisions/",
            //        Area = "Medicals",
            //        Controller = "Admisions",
            //        Action = "Index",
            //        Order = 0,
            //        Class = "btn btn-default",
            //        Icon = "/Content/Icons/admision.png",
            //        StatusId = 1
            //    }
            //);
            //context.SaveChanges();
